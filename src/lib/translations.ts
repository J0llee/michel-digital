...
export const translations = {
  ...
  hero: {
    ...
    subtext: {
      fi: 'Tämä verkkosivu on 100% meidän itsemme suunnittelema ja toteuttama käyttäen Gemini-tekoälyä. Rakennamme parhaillaan portfoliotamme – tule mukaan kasvutarinaan.',
      en: "This website was 100% designed and built by us using Gemini AI. We are currently building our portfolio – join our growth story.",
    },
